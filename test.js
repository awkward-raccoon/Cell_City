...
const formattedBrands = brands.map(c => ({
  value: c,
  label: c.split('-').join(' '),
  checked: false
}));
...
// Output the results
formattedBrands; // This will output the formatted brands array in Quokka.js
formattedCategories; // This will output the formatted categories array in Quokka.js